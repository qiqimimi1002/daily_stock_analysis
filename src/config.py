...
class Config:
    ...
    gemini_retry_max_delay: float = 30.0  # 单次重试最大等待（秒）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            gemini_retry_max_delay=parse_env_float(os.getenv('GEMINI_RETRY_MAX_DELAY'), 30.0, field_name='GEMINI_RETRY_MAX_DELAY', minimum=0.0),
