...
model/signal identities, strict signal serialization, a V2.1-aligned offline
universe adapter and a five-field future-outcome handoff. It contains no real
benchmark models, outcome calculations or production integration.
